...
INSERT INTO users (id, last_name, first_name, email, phone, password, location_id, created_at, deleted_at) VALUES
    (1, 'Летавина', 'Елизавета', 'elizaveta2042@ya.ru', 79818313615, '1234', 1, now(), NULL),
    (2, 'Коленко', 'Афанасий', 'afanasiy18011985@mail.ru', 79798435867, '1234', 2, now(), NULL),
    (3, 'Северинов', 'Василий', 'vasiliy16011990@yandex.ru', 79589027647, '1234', 5, now(), NULL),
    (4, 'Есаулов', 'Никита', 'nikita91@ya.ru', 79592873253, '1234', 5, now(), NULL),
    (5, 'Куняев', 'Даниил', 'daniil6777@mail.ru', 79529038435, '1234', 6, now(), NULL),
    (6, 'Блаженова', 'Виктория', 'viktoriya5412@mail.ru', 79591498936, '1234', 7, now(), NULL),
    (7, 'Островерхова', 'Катерина', 'katerina1969@ya.ru', 79138231819, '1234', 8, now(), NULL);
