...
ALTER TABLE movements ADD CONSTRAINT movements_item_id FOREIGN KEY (item_id) REFERENCES items (id);
...
ALTER TABLE coordinations ADD CONSTRAINT chief_user_id FOREIGN KEY (chief_user_id) REFERENCES users (id);
