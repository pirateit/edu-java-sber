...
INSERT INTO locations (id, title, parent_id, depth, responsible_user_id) VALUES
    (1, 'Моя компания', DEFAULT, DEFAULT, DEFAULT),
    (2, 'Москва', 1, 1, DEFAULT),
    (3, 'Краснодар', 1, 1, DEFAULT),
    (4, 'Волгоград', 1, 1, DEFAULT),
    (5, 'Офис на ул. Ленина', 2, 2, DEFAULT),
    (6, 'Склад на пр. Мира', 2, 2, DEFAULT),
    (7, 'Магазин на Сапрунова', 3, 2, DEFAULT),
    (8, 'Магазин на Исторической', 4, 2, DEFAULT);
